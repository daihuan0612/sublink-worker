...
export const translations = {
  ...
  'en-US': {
    ...
    pageDescription: 'Subscription Center',
  ...
  'ru': {
    ...
    pageDescription: 'Центр подписок',
    pageKeywords: 'ссылка подписки,преобразование,Xray,SingBox,Clash,Surge',
    pageTitle: 'Центр подписок',
    ogTitle: 'Центр подписок',
